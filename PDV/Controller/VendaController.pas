...
uses
  Classes, SQLdb, SysUtils, VendaCabecalhoVO, VendaDetalheVO, fgl,
...
type
  ...
  public
    ...
    class function VendaAberta: TVendaDetalheListaVO; overload;
    class function VendaAberta(p: String): Boolean; overload;
    class function VendaComProblemas: TVendaDetalheListaVO;
    class Procedure CancelaVenda(pVendaCabecalho: TVendaCabecalhoVO; pListaVendaDetalhe: TVendaDetalheListaVO);
    ...
    class procedure AtualizaItens(pListaVendaDetalhe: TVendaDetalheListaVO);
    class function RetornaCabecalhoDaUltimaVenda:TVendaCabecalhoVO;
    class function RetornaDetalheDaUltimaVenda(IdCabecalho:integer): TVendaDetalheListaVO;
    class procedure AlteraClienteNaVenda(IdVenda, IdCliente: Integer; CpfCnpj, NomeCliente: String);
  end;

implementation

uses Udmprincipal, UEcf, ImpressoraVO, ImpressoraController, UfrmCheckout;
...
begin
  ...
  try
    try
      Ccf := StrToIntDef(dmprincipal.ACBrECF.NumCCF,0);
  ...
  try
    try
      ...
      begin
        ...
        if dmprincipal.BancoPAF = 'MySQL' then
        begin
...
class procedure TVendaController.AtualizaItens(pListaVendaDetalhe: TVendaDetalheListaVO);
var
  Tripa, Hash: String;
  i: integer;
  VendaDetalhe: TVendaDetalheVO;
...
class function TVendaController.VendaAberta: TVendaDetalheListaVO;
var
...
class function TVendaController.RetornaDetalheDaUltimaVenda(IdCabecalho: integer): TVendaDetalheListaVO;
var
  ListaVenda: TVendaDetalheListaVO;
  VendaDetalhe: TVendaDetalheVO;
begin
